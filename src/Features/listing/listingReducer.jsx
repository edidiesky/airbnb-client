...
export const getAllGigs = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    try {
      ...
      let GigsUrl = `https://airbnb-api-edidiesky.vercel.app/api/v1/listing`;
      if (sort) {
...
export const getSingleGigsDetails = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    try {
      const { data } = await axios.get(`https://airbnb-api-edidiesky.vercel.app/api/v1/listing/${name}`);
...
export const getHostListing = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    try {
      const { data } = await axios.get(`https://airbnb-api-edidiesky.vercel.app/api/v1/listing/host/${name}`);
...
export const CreateSingleGig = createAsyncThunk(
  ...
  async (GigsData, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.post(`https://airbnb-api-edidiesky.vercel.app/api/v1/listing`, GigsData, config);
  ...
  async ({ GigsData }, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://airbnb-api-edidiesky.vercel.app/api/v1/listing/${_id}`,
        GigsData,
        config
      );
      // console.log(GigsData)
...
export const DeleteGig = createAsyncThunk(
  ...
  async (Gigsid, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.delete(`https://airbnb-api-edidiesky.vercel.app/api/v1/listing/${Gigsid}`, config);
      return Gigsid;
    } catch (error) {
      return thunkAPI.rejectWithValue(
        error.response && error.response.data.message
  ...
  async ({ Reviewdata, id }, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `https://airbnb-api-edidiesky.vercel.app/api/v1/listing/review/${id}`,
        Reviewdata,
        config
      );
      return data.message;
...
export const getTopRatedGigs = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.get(`https://airbnb-api-edidiesky.vercel.app/api/v1/listing/rated`, config);
...
export const getGigsStats = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.get(`https://airbnb-api-edidiesky.vercel.app/api/v1/listing/stats`, config);
      return data.stats;
    } catch (error) {
      return thunkAPI.rejectWithValue(
        error.response && error.response.data.message
...
export const addListToWish = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://airbnb-api-edidiesky.vercel.app/api/v1/listing/wish/${name}`,
        null,
        config
      );
  ...
  async (name, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `https://airbnb-api-edidiesky.vercel.app/api/v1/listing/wish`,
        config
      );
      return data.listing;
    } catch (error) {
